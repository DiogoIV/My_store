...
function App() {
    const categorias = [
        { id: 1, nome: "Todos", icon: <PiGridFour className='icon_categorie' /> },
        { id: 2, nome: "Cactos", icon: <PiCactusBold className='icon_categorie' /> },
        { id: 3, nome: "Suculentas", icon: <IoFlowerOutline className='icon_categorie' /> },
        { id: 4, nome: "Flores", icon: <LuFlower className='icon_categorie' /> },
        { id: 5, nome: "Plantas verdes", icon: <PiPlant className='icon_categorie' /> }
    ]
    ...
    return (
        <>
            <Home produtos={produtos} categorias={categorias}/>
